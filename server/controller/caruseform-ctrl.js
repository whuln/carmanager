...
module.exports = class CaruseformController {
  //用车人员获取用车信息
  static async userGetCaruseform(ctx) {
  ...
  //司机获取用车信息
  static async driverGetCaruseform(ctx) {
    //useraccount, isback = null
    let data = ctx.request.body;
    console.log(data);
    let cuf = await CarDispatchForm.findOne({
  ...
  //部门主任、主管领导获取用车信息
  static async dmGetCaruseform(ctx) {
    //useraccount, isback = null
    let data = ctx.request.body,
      where = {};
    console.log(data);
  ...
  //管理员获取用车信息
  static async adminGetCaruseform(ctx) {
    //useraccount, isback = null
    let where = {
      isreceived: false,
      [Op.or]: [
  ...
  //用车人填写车辆申请信息
  static async userAddCaruseform(ctx) {
    let data = ctx.request.body;
    let r = null;
  ...
  //修改车辆申请信息
  static async upsertCaruseform(ctx) {
    let data = ctx.request.body;
    console.log(data);
    try {
